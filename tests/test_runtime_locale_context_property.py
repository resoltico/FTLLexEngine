...
# Locales for oracle comparison: all ASCII-digit locales.
# ar-SA uses Arabic-Indic digits (U+0660..U+0669) which cannot be
...
class TestFormatNumberMinMaxClamping:
    """Property tests verifying min/max fraction digit clamping behavior."""
