...
class TestSerializerExpressions:
    ...
    def test_serialize_string_literal(self) -> None:
        ...
        msg = Message(
            id=Identifier(name="test"),
            value=Pattern(elements=(Placeable(expression=StringLiteral(value="test value")),)),
            attributes=(),
        )
        resource = Resource(entries=(msg,))
    ...
    def test_serialize_string_literal_with_escapes(self) -> None:
        ...
        msg = Message(
            id=Identifier(name="test"),
            value=Pattern(
                elements=(Placeable(expression=StringLiteral(value='quote: " backslash: \\')),)
            ),
            attributes=(),
        )
        resource = Resource(entries=(msg,))
    ...
    def test_serialize_variable_reference(self) -> None:
        ...
        msg = Message(
            id=Identifier(name="test"),
            value=Pattern(
                elements=(Placeable(expression=VariableReference(id=Identifier(name="count"))),)
            ),
            attributes=(),
        )
        resource = Resource(entries=(msg,))
    ...
    def test_serialize_message_reference_simple(self) -> None:
        ...
        msg = Message(
            ...
            value=Pattern(
                elements=(
                    Placeable(
                        expression=MessageReference(id=Identifier(name="other"), attribute=None)
                    ),
                )
            ),
            attributes=(),
                ...
                elements=(
                    Placeable(
                        expression=FunctionReference(
                            ...
                            arguments=CallArguments(
                                positional=(VariableReference(id=Identifier(name="date")),),
                                named=(
                                    NamedArgument(
                        ...
                        expression=SelectExpression(
                            ...
                            variants=(
                                ...
                                Variant(
                                    ...
                                    value=Pattern(elements=(TextElement(value="many emails"),)),
                                    default=True,
                                ),
                            ),
                        )
                    ...
                    Placeable(
                        expression=SelectExpression(
                            ...
                            variants=(
                                Variant(
                                    key=Identifier(name="one"),
                                    value=Pattern(elements=(TextElement(value="one file"),)),
                                    default=False,
                                ),
                                Variant(
                                    key=Identifier(name="other"),
                ...
                elements=(
                    ...
                    Placeable(
                        expression=FunctionReference(
                            id=Identifier(name="NUMBER"),
                            arguments=CallArguments(
                                positional=(VariableReference(id=Identifier(name="price")),),
                                named=(
                                    NamedArgument(
                                        name=Identifier(name="minimumFractionDigits"),
                                        value=NumberLiteral(value=2, raw="2"),
