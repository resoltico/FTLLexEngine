...
Usage:
    python fuzz/replay_finding.py .fuzz_corpus/structured/findings/finding_0001_source.ftl
    python fuzz/replay_finding.py .fuzz_corpus/structured/findings/  # replay all
...
def main() -> int:
    """Entry point."""
    if len(sys.argv) < 2:
        print("Usage: python fuzz/replay_finding.py <source.ftl | findings_dir/>")
        return 0
